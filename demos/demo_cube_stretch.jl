# demo_cube_stretch.jl
# Description: A demo script to create a cube and apply a uniaxial tension using Comodo and FEBio.

# This demo is a copied and modified verion of demo_febio_0001_cube_uniaxial_hyperelastic.jl
# which can be found in the FEBio.jl package examples folder.
#https://github.com/COMODO-research/FEBio.jl/blob/main/examples/demo_febio_0001_cube_uniaxial_hyperelastic.jl
# I use it here to practice creating and adjusting FEBio input files
